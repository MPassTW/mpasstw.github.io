  ...
  return (
    <section className="min-h-screen flex flex-col justify-between pt-[60px] bg-white">
      ...
      <div className="border-b border-[#e8e8e8] px-6 md:px-10 py-3 flex items-center justify-between max-w-screen-xl mx-auto w-full">
        <span
          className="text-[11px] tracking-[0.15em] text-[#999] uppercase"
          style={{ fontFamily: "'JetBrains Mono', monospace" }}
        >
          MemberPass · 會員認證中心
        </span>
        <span
          className="text-[11px] tracking-[0.1em] text-[#999] uppercase"
          style={{ fontFamily: "'JetBrains Mono', monospace" }}
        >
          Taipei · 2026
        </span>
      ...
      <div className="flex-1 flex items-center px-6 md:px-10 max-w-screen-xl mx-auto w-full py-16">
        <div className="w-full">
          {/* Overline */}
          <p
            className="text-[12px] tracking-[0.2em] text-[#1a56db] uppercase mb-6"
            style={{
          ...
          <h1
            ...
            style={{
              fontFamily:
                "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
            }}
          >
            零摩擦的
            <br />
            <span style={{ color: "#1a56db" }}>會員體驗</span>
            <br />
            <span style={{ color: "#0d1b2a" }}>從這裡開始</span>
            <br />
          </h1>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-t border-[#e8e8e8] pt-8">
            <p
              className="text-[#555] text-base leading-relaxed max-w-md"
              style={{
                fontFamily: "'Noto Sans TC', sans-serif",
              }}
            >
      ...
      <div className="border-t border-[#e8e8e8] px-6 md:px-10 max-w-screen-xl mx-auto w-full">
        <div className="grid grid-cols-3 divide-x divide-[#e8e8e8]">
          {[
            {
              n: "62.2%",
              label: "消費者因步驟冗長放棄申請會員",
            },
            {
              n: "68.9%",
              label: "消費者對結帳時切換 App 感到困擾",
            },
            {
              n: "3 步驟",
              label: "使用 MemberPass 完成會員綁定",
            },
          ].map((s) => (
            <div key={s.n} className="py-7 px-6 first:pl-0">
              <div
                className="text-[28px] md:text-[36px] font-black text-[#0d1b2a] leading-none mb-1.5"
                style={{
              ...
              <div
                className="text-[12px] text-[#888] leading-snug"
                style={{
                  fontFamily: "'Noto Sans TC', sans-serif",
                }}
              >
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        <div className="grid md:grid-cols-[1fr_2fr] gap-16 md:gap-24 items-start">
          ...
          <div className="md:sticky md:top-28">
            <p
              className="text-[11px] tracking-[0.2em] uppercase text-[#999] mb-4"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
              }}
            >
            ...
            <h2
              className="text-3xl font-black text-[#0d1b2a] leading-tight"
              style={{
                fontFamily:
                  "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
              }}
          ...
          >
            {[
              ...
              <div
                key={item.n}
                className="border-b border-[#ddd] py-10 grid grid-cols-[80px_1fr] gap-6"
              >
                <div>
                  <span
                  ...
                  <div
                    className="text-[28px] font-black text-[#1a56db] leading-none mt-1"
                    style={{
                      fontFamily:
                ...
                <div>
                  <h3
                    className="font-bold text-[#0d1b2a] mb-2 text-lg"
                    style={{
                      fontFamily: "'Noto Sans TC', sans-serif",
                    }}
                  >
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          <div className="flex items-center gap-4 mb-16">
            <p
              className="text-[11px] tracking-[0.2em] uppercase text-[#999]"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
              }}
            >
          ...
          {/* Headline */}
          <h2
            className="text-[clamp(32px,5vw,72px)] font-black text-[#0d1b2a] leading-tight tracking-tight mb-20"
            style={{
              fontFamily:
                "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
            }}
          ...
          <div className="grid md:grid-cols-2 gap-x-16 gap-y-0">
            {[
              ...
              <div
                key={i}
                className="py-8 border-b border-[#ececec] flex gap-6 group"
              >
                <span
                  className="text-[10px] font-bold tracking-widest text-[#bbb] mt-1 w-20 flex-shrink-0"
                  style={{
                    fontFamily: "'JetBrains Mono', monospace",
                  }}
                >
                ...
                <div>
                  <h3
                    className="font-bold text-[#0d1b2a] mb-1.5 group-hover:text-[#1a56db] transition-colors"
                    style={{
                      fontFamily: "'Noto Sans TC', sans-serif",
                    }}
                  >
  ...
  const steps = [
    {
      n: "01",
      title: "預填會員資料",
      body: "消費者在 MemberPass 平台一次填寫基本資訊，生成專屬識別碼與安全動態條碼。",
    },
    {
      n: "02",
      title: "給商家掃描",
      body: "結帳時出示 MemberPass 條碼，商家 POS 系統掃描並透過 OAuth 2.0 完成身份驗證。",
    },
    {
      n: "03",
      title: "自動完成！",
      body: "系統自動累積點數並完成會員綁定。結帳後商家再透過優惠推播，引導消費者決定是否下載自家 App。",
    },
  ];
    ...
    <section id="how" className="bg-[#0d1b2a]" ref={ref}>
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          <div className="flex items-center gap-4 mb-16">
            <p
              className="text-[11px] tracking-[0.2em] uppercase text-[#555]"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
              }}
            >
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-16 items-start mb-20">
            ...
            <p
              className="text-[#7a90a8] leading-relaxed pt-2"
              style={{
                fontFamily: "'Noto Sans TC', sans-serif",
              }}
            >
              MemberPass
              的設計哲學是：讓複雜的事情在後端發生，讓消費者感覺什麼都沒做。
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#1e2d44]">
            {steps.map((step) => (
              <div key={step.n} className="bg-[#0d1b2a] p-10">
                <div
                  className="text-[11px] tracking-widest text-[#1a56db] mb-6"
                  style={{
                    fontFamily: "'JetBrains Mono', monospace",
                  }}
                >
                ...
                <p
                  className="text-sm text-[#7a90a8] leading-relaxed"
                  style={{
                    fontFamily: "'Noto Sans TC', sans-serif",
                  }}
                >
          ...
          <div className="mt-12 pt-10 border-t border-[#1e2d44] flex flex-col md:flex-row md:items-center gap-6">
            <span
              className="text-[11px] tracking-widest uppercase text-[#555] flex-shrink-0"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
              }}
            >
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#e8e8e8]">
            {[
              ...
              <div key={g.label} className="bg-white p-10">
                ...
                <h3
                  className="text-2xl font-black text-[#0d1b2a] mb-8"
                  style={{
                    fontFamily:
                      "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
                  }}
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-16">
            <h2
              className="text-4xl font-black text-[#0d1b2a] leading-tight"
              style={{
                fontFamily:
                  "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
              }}
            ...
            <p
              className="text-[#666] leading-relaxed pt-1"
              style={{
                fontFamily: "'Noto Sans TC', sans-serif",
              }}
            >
              MemberPass
              的擴張路徑清晰且具體：先在台灣零售市場深耕，再橫跨至交通票券與展場門票，最終整合國際條碼體系。
            </p>
          </div>
          ...
          <div className="space-y-0">
            {[
              ...
              <div
                key={i}
                className="border-b border-[#ddd] py-10 grid md:grid-cols-[180px_1fr] gap-8"
              >
                <div>
                  <p
                    className="text-[10px] tracking-widest uppercase text-[#aaa] mb-1"
                    style={{
                      fontFamily: "'JetBrains Mono', monospace",
                    }}
                  >
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          ...
          <div className="grid md:grid-cols-[1fr_1.8fr] gap-16 mb-20">
            ...
            <div>
              <p
                className="text-[#7a90a8] leading-relaxed mb-6"
                style={{
                  fontFamily: "'Noto Sans TC', sans-serif",
                }}
              >
                大型連鎖品牌有龐大資源建立流暢的 App
                與會員漏斗，但中小型商家往往面臨「有 App
                但無人下載」的窘境。 MemberPass
                作為基礎設施，讓中小型商家能享有等同大企業級別的低阻力獲客通道。
              </p>
              <div className="flex flex-wrap gap-3">
                {[
                  "SDG 8 尊嚴就業",
            ...
            {[
              {
                tag: "S — Social",
                title: "賦能中小企業",
                body: "讓行銷資源有限的商家也能擁有強大的會員導流能力，同時改善收銀員的工作壓力。",
              },
              {
                tag: "G — Governance",
                title: "資安合規保護",
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-16 mb-16">
            <div>
              <h2
                className="text-4xl font-black text-[#0d1b2a] leading-tight mb-4"
                style={{
                  fontFamily:
                    "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
                }}
            ...
            <div className="flex flex-col gap-0">
              {[
                ...
                <div
                  key={i}
                  className="border-b border-[#ececec] py-10 grid sm:grid-cols-[220px_1fr] gap-8"
                >
                  <div>
                    <p
                    ...
                    <h3
                      className="text-2xl font-black text-[#0d1b2a]"
                      style={{
                        fontFamily:
                          "'Plus Jakarta Sans', 'Noto Sans TC', sans-serif",
                      }}
                  ...
                  <div>
                    <p
                      className="text-sm text-[#666] leading-relaxed mb-5"
                      style={{
                        fontFamily:
                          "'Noto Sans TC', sans-serif",
                      }}
      ...
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        >
          <div className="grid md:grid-cols-[1fr_auto] gap-12 items-end">
            <div>
              <p
                className="text-[11px] tracking-[0.2em] uppercase text-[rgba(255,255,255,0.5)] mb-6"
                style={{
                  fontFamily: "'JetBrains Mono', monospace",
                }}
              >
    ...
    <footer className="bg-[#0a1220] py-10 px-6 md:px-10">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <ImageWithFallback
          src={logoImg}
          alt="MemberPass"
          className="h-7 w-auto object-contain opacity-60 brightness-200"
        />
